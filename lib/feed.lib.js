...
/**
 * Get the rss url of website, parse and send it to save into database.
 * [TODO] Implement a flag to control the time to get the recent post in rss channel.
 * [TODO] Implement function that receives the whole records from database and send it to client.
 * @param {*} website 
 */
